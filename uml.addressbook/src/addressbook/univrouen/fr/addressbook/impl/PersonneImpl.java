...
public class PersonneImpl extends MinimalEObjectImpl.Container implements Personne {
	...
	public String getIdentifier() {
		...
		identifier+= getNom().substring(0, 3);
		identifier+= getPrenom().substring(0, 3);
		identifier+= getAge();
	 ...
	 * @generated
	 */
	public boolean contraintenom(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		/**
		 * 
		 * inv contraintenom:
		 *   let severity : Integer[1] = 'Personne::contraintenom'.getSeverity()
		 *   in
		 *     if severity <= 0
		 *     then true
		 *     else
		 *       let status : OclAny[1] = self.nom = nom.toUpperCase()
		 *       in
		 *         'Personne::contraintenom'.logDiagnostic(self, null, diagnostics, context, null, severity, status, 0)
		 *     endif
		 */
		final /*@NonNull*/ /*@NonInvalid*/ Evaluator evaluator = PivotUtilInternal.getEvaluator(this);
		final /*@NonNull*/ /*@NonInvalid*/ IntegerValue severity_0 = ClassUtil.nonNullState(CGStringGetSeverityOperation.INSTANCE.evaluate(evaluator, AddressbookTables.STR_Personne_c_c_contraintenom));
		...
		if (le) {
		    ...
		    final /*@NonInvalid*/ boolean logDiagnostic = ClassUtil.nonNullState(CGStringLogDiagnosticOperation.INSTANCE.evaluate(evaluator, TypeId.BOOLEAN, AddressbookTables.STR_Personne_c_c_contraintenom, this, null, diagnostics, context, null, severity_0, CAUGHT_status, AddressbookTables.INT_0).booleanValue());
	 ...
	 * @generated
	 */
	public boolean contrainteage(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		/**
		 * 
		 * inv contrainteage:
		 *   let severity : Integer[1] = 'Personne::contrainteage'.getSeverity()
		 *   in
		 *     if severity <= 0
		 *     then true
		 *     else
		 ...
		 *       in
		 *         'Personne::contrainteage'.logDiagnostic(self, null, diagnostics, context, null, severity, status, 0)
		 *     endif
		 */
		final /*@NonNull*/ /*@NonInvalid*/ Evaluator evaluator = PivotUtilInternal.getEvaluator(this);
		final /*@NonNull*/ /*@NonInvalid*/ IntegerValue severity_0 = ClassUtil.nonNullState(CGStringGetSeverityOperation.INSTANCE.evaluate(evaluator, AddressbookTables.STR_Personne_c_c_contrainteage));
		final /*@NonInvalid*/ boolean le = ClassUtil.nonNullState(OclComparableLessThanEqualOperation.INSTANCE.evaluate(evaluator, severity_0, AddressbookTables.INT_0).booleanValue());
		/*@NonInvalid*/ boolean symbol_0;
		if (le) {
		    symbol_0 = ValueUtil.TRUE_VALUE;
		    ...
		    final /*@NonInvalid*/ boolean logDiagnostic = ClassUtil.nonNullState(CGStringLogDiagnosticOperation.INSTANCE.evaluate(evaluator, TypeId.BOOLEAN, AddressbookTables.STR_Personne_c_c_contrainteage, this, null, diagnostics, context, null, severity_0, CAUGHT_status, AddressbookTables.INT_0).booleanValue());
		    symbol_0 = logDiagnostic;
		}
		return Boolean.TRUE == symbol_0;
	}

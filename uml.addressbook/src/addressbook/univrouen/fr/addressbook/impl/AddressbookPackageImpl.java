...
public class AddressbookPackageImpl extends EPackageImpl implements AddressbookPackage {
	...
	public void initializePackageContents() {
		...
		addEOperation(adresseEClass, ecorePackage.getEString(), "display", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(personneEClass, ecorePackage.getEString(), "display", 0, 1, IS_UNIQUE, IS_ORDERED);

		EOperation op = addEOperation(personneEClass, ecorePackage.getEBoolean(), "contraintenom", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(personneEClass, ecorePackage.getEBoolean(), "contrainteage", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(adressBookEClass, ecorePackage.getEBoolean(), "addContact", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (personneEClass, 
		   source, 
		   new String[] {
			 "constraints", "contrainteage contraintenom"
		   });
	}
